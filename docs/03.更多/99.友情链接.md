...
```yaml
- name: Sirius' blog # 昵称
  desc: 怕什么真理无穷，进一寸有一寸的欢喜 # 介绍
  avatar: https://cdn.jsdelivr.net/gh/Sirius0v0/image_store/img/avatar.png # 头像
  link: https://github.com/Sirius0v0  # 链接
```
